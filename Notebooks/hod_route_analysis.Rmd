...
route_deviations_df <- dplyr::left_join(route_deviations_df, number_instances, by=c('route_start'='sourceid','route_end'='dstid'))
route_deviations_df %>% filter(route_deviation > 1800 & total_hod > 6) %>% arrange(desc(route_deviation))
```
